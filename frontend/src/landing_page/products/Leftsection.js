...
function Leftsection ({imageURL,productName,productDescripition,tryDemo,learnMore,googlePlay,appStore,}) {
    return ( 
        <div className='container mt-5'>
            <div className='row '>
                ...
                <div className='col-6 p-5 mt-5'>
                    ...
                    <a href={tryDemo}><img src="media/images/appstoreBadge.svg" style={{marginLeft:"50px"}}/></a></div>
